...
Enemy = enchant.Class.create(Bear, {
    initialize: function() {
        Bear.call(this);
        this.frame = 5;
        this.y = -32;function rand(numloot) {
            return  Math.floor(Math.random()* numloot);
        }
...
window.onload = function() {
    ...
    game.onload = function() {
        ...
        player.x = 144;
        player.y = 144;stage.addChild(loot);
        ...
        game.rootScene.addEventListener('enterframe', function() {
            info.text = 'Entity: ' + Entity.collection.length + '<br/>' +
                ...
                'Bullet: ' + Bullet.collection.length;stage.addChild(loot);
            if (game.frame % 30 == 0) {
