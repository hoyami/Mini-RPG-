//plugin enchantjs start/end game

enchant.nineleap = { assets: ['img/Charon.gif', 'img/Overworld.gif'] };
enchant.nineleap.Game = enchant.Class.create(enchant.Game, {
    initialize: function(width, height) {
        ...
        this.addEventListener('load', function() {
            ...
            this.startScene.image = this.assets['img/Charon.gif'];
            ...
            this.endScene.image = this.assets['img/Overworld.gif'];
        });
    },
